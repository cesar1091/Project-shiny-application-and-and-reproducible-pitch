...
The application is running on (https://cfernandez.shinyapps.io/Project_week_4/)

ui.R, and Server.R Code in my github repository (https://github.com/cesar1091/Project-shiny-application-and-and-reproducible-pitch.git)
